...
from writing.char_level_model.encoding import slice_sequences, encode_sequences, encode_labels
from writing.char_level_model.lstm_model import LSTMModel
...
def train_lstm_model(params: Dict, full_text: str, model_path=None, weights_path=None):
    ...
    x, y = extract_data_with_labels(
        full_text, params, char2int_encoder)
...
def extract_data_with_labels(full_text: str, params: Dict, char2int_encoder: Dict):
    """
    ...
    Args:
        ...
        char2int_encoder: encoder mapping char to integers

    Returns:
        encoded data and labels as tuples
    """
    subtexts, targets = slice_sequences(
        full_text, params.get("sequence_length"), params.get("step"))
    x = encode_sequences(subtexts, char2int_encoder)
    y = encode_labels(targets, char2int_encoder)
    return x, y
